...
<<<<<<< HEAD:keyboards/keychron/s1/ansi/white/keymaps/default/keymap.c
...
=======
    ...
    [WIN_FN] = LAYOUT(
        ...
        _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,  _______,            _______,
        _______,  _______,  _______,  _______,                      _______,                      _______,  _______,  _______,  _______,  _______,  _______,  _______),
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k3_pro/jis/white/keymaps/default/keymap.c
};
