...
<<<<<<< HEAD:keyboards/keychron/q1v2/jis_encoder/jis_encoder.c
...
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/q3_pro/ansi_encoder_se/ansi_encoder_se.c
 *   driver
 *   |  R location
 *   |  |       G location
 *   |  |       |       B location
