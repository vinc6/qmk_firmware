...
<<<<<<< HEAD:keyboards/keychron/c1_pro/ansi/rgb/config.h
...
#endif
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k5_pro/ansi/rgb/config.h
