...
<<<<<<< HEAD:keyboards/keychron/c2_pro/ansi/white/keymaps/default/keymap.c
    [MAC_BASE] = LAYOUT(
...
=======
    ...
    [WIN_FN] = LAYOUT_108_ansi(
        ...
        _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,            _______,           _______,           _______, _______, _______, _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______, _______,  _______,  _______, _______,          _______),
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k5_pro/ansi/white/keymaps/default/keymap.c
};
