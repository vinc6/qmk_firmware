...
<<<<<<< HEAD:keyboards/keychron/q1v2/jis_encoder/keymaps/default/keymap.c
    [MAC_BASE] = LAYOUT(
...
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k5_pro/jis/rgb/keymaps/via/keymap.c
