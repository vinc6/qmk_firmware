...
<<<<<<< HEAD:keyboards/keychron/q8/ansi_encoder/keymaps/default/keymap.c
    [_FN1] = LAYOUT_ansi_69(
...
=======
    ...
    [WIN_FN1] = LAYOUT_69_ansi(
        ...
        _______,           RGB_RMOD, RGB_VAD, RGB_HUD, RGB_SAD, RGB_SPD,  _______, NK_TOGG, _______, _______,  _______,  _______,  _______, _______,
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k11_pro/ansi_encoder/rgb/keymaps/via/keymap.c
        _______, _______,  _______,           _______,          _______,  _______,          _______,           _______,            _______, _______, _______),
