...
<<<<<<< HEAD:keyboards/keychron/q3/iso_encoder/keymaps/default/keymap.c
...
=======
    ...
    [FN2] = LAYOUT_iso_68(
        ...
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,  _______,  _______, _______),
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/q2_pro/iso_encoder/keymaps/via/keymap.c
};
