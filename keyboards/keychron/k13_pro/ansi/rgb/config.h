...
<<<<<<< HEAD:keyboards/keychron/q9_plus/config.h
=======
#ifdef RGB_MATRIX_ENABLE
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k13_pro/ansi/rgb/config.h
