...
<<<<<<< HEAD:keyboards/keychron/q1v2/jis/keymaps/default/keymap.c
    [MAC_BASE] = LAYOUT(
...
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k9_pro/jis/rgb/keymaps/via/keymap.c
