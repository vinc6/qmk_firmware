...
<<<<<<< HEAD:keyboards/keychron/c2_pro/ansi/white/config.h
...
#endif
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/k9_pro/ansi/white/config.h
