...
<<<<<<< HEAD:keyboards/keychron/q1v2/iso_encoder/iso_encoder.c
...
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/q5_pro/iso_encoder/iso_encoder.c
 *   driver
 *   |  R location
 *   |  |       G location
 *   |  |       |       B location
