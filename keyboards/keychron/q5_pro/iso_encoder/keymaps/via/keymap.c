...
<<<<<<< HEAD:keyboards/keychron/v5/iso_encoder/keymaps/default/keymap.c
...
>>>>>>> 4ae5990fcc (Added wireless support; Added Lemokey L3; Added Keychron V1 Max):keyboards/keychron/q5_pro/iso_encoder/keymaps/via/keymap.c
};
